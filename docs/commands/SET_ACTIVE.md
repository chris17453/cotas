...
- **`file_descriptor_name`** · `sac` · *Required*

  The FD name (or schema for 3.0 users) for the files to be switched. The name can be a maximum of 8 characters. Must be the actual FD name.

- **`file_name`** · `sac` · *Required*

  The name of the file that needs to be SETACT. The name can be a maximum of 8 characters. Must be the actual file name.
