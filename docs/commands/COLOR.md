...
This command will define the beginning of a User Defined Command (UDC).
...
- **`HIGH`** · `f/c/e` · *Optional*
  ...
  This color is used for highlight bars in menus.
...
The color information is kept in TASCOLOR.OVL. Since each user can have their own copy of the file, they can have their own colors without having to create separate programs for each.
