...
- **`start_val`** · `f/c/e` · *Required*
  ...
  The character position of the beginning of the block of characters. The first character in the memory area is at position 1.

- **`stop_val`** · `f/c/e` · *Required*

  The character position of the end of the block of characters.

- **`NCHR #_of_chrs`** · `f/c/e` · *Required*

  Number of characters to add or subtract.

- **`DOwhat_to_do`** · `f/c/e` · *Required*
