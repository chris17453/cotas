...
- **`number_of_characters`** · `f/c/e` · *Optional*

  number_of_characters - f/c/e - Optional - The number of characters to clear. If this option is not set, the command will clear the remaining line.
